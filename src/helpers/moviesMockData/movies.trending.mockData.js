export const TrendingMoviesMockData = {
  data: {
    page: 1,
    results: [
      {
      ...
      },
      {
        ...
        release_date: '2020-09-04',
        original_language: 'en',
        original_title: 'Guest House',
        genre_ids: [
          35
        ],
        backdrop_path: '/py7rUzTKmOrPSaL7Q7q6BYvXzJB.jpg',
        adult: false,
        ...
        poster_path: '/8Bcjh3ghBH0pL0eCudWNVUVwy5l.jpg',
        popularity: 47.071,
        media_type: 'movie'
      },
      {
      ...
      },
      {
        ...
        backdrop_path: '/hH1vDR2vz9aCZMm2NfR6Qaar5ZK.jpg',
        adult: false,
        overview: 'An anarchic, hip-hop inspired comedy that follows four city boys on a wilderness trek as they try to escape a mysterious huntsman.',
        poster_path: '/b52nqFj5XrBNA7MhqcnENvFsHtx.jpg',
        popularity: 48.834,
        media_type: 'movie'
      },
      {
